...
```
Browse and insert 7,400+ brand SVG logos directly into your Figma designs.
One click and the mark drops in as an editable vector node.

What's in the catalog:
- 7,400+ brand icons across finance, gaming, entertainment, dev tools,
...
```
Search, preview, and insert from 7,400+ brand SVG logos.
```
