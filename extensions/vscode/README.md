...
Search and copy 7,400+ SVG icons directly from VS Code. Brand logos, AWS, Azure, GCP, and Kubernetes architecture icons.

## Features

- **Search** across 7,400+ icons from the command palette
